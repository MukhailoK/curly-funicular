...
VALUES ('SmallCare: XS', 'up to 2.5 kg (small breed)',
       ...
       ('Completely: XL', '40 kg and above',
        'XL breeds from 40 kg, e.g. Chow Chow, Mountain Dog, Newfoundland, American Akita, Royal Poodle.', 209.00,
        '02:00:00');
...
VALUES (1, 1, 1, TIMESTAMP '2024-02-02 10:00:00', TIMESTAMP '2024-02-02 12:00:00',
        'scheduled'),                                                                           -- клиент 1, мастер 1, собака 1
       (1, 2, 2, TIMESTAMP '2024-02-02 12:00:00', TIMESTAMP '2024-02-02 14:00:00',
        'scheduled'),                                                                           -- клиент 1, мастер 2, собака 2
       (2, 1, 3, TIMESTAMP '2024-02-02 14:00:00', TIMESTAMP '2024-02-02 16:00:00',
        'scheduled'),                                                                           -- клиент 2, мастер 1, собака 3
       (2, 2, 4, TIMESTAMP '2024-02-02 16:00:00', TIMESTAMP '2024-02-02 18:00:00',
        'scheduled'),                                                                           -- клиент 2, мастер 2, собака 4
       (3, 3, 5, TIMESTAMP '2024-02-05 10:00:00', TIMESTAMP '2024-02-02 12:00:00', 'scheduled'),-- клиет 3, мастер 1, собака 5
       (1, 1, 1, TIMESTAMP '2024-02-05 12:00:00', TIMESTAMP '2024-02-02 14:00:00',
        'scheduled'),                                                                           -- клиент 1, мастер 2, собака 2
       (1, 2, 2, TIMESTAMP '2024-02-06 14:00:00', TIMESTAMP '2024-02-02 16:00:00',
        'scheduled'),                                                                           -- клиент 2, мастер 1, собака 3
       (2, 2, 2, TIMESTAMP '2024-02-06 16:00:00', TIMESTAMP '2024-02-02 18:00:00',
        'scheduled'),                                                                           -- клиент 2, мастер 2, собака 4
       (3, 2, 9, TIMESTAMP '2024-02-07 10:00:00', TIMESTAMP '2024-02-02 12:00:00', 'scheduled');-- клиет 3, мастер 1, собака 5
